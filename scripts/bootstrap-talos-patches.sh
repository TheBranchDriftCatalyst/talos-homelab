...
PATCHES=(
  ...
  "${REPO_ROOT}/docs/05-runbooks/talos-kubelet-maxpods-patch.yaml talos-kubelet-memory-reserve-patch.yaml talos-kubelet-image-gc-patch.yaml|maxPods 110 -> 200 (TALOS-d5b5)"
)
