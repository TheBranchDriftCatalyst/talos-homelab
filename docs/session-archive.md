# Session Archive — talos-homelab

Sessions rolled out of [`SESSION_STATUS.md`](../SESSION_STATUS.md) once the index exceeds its
retention window (last 10). Newest first. Nothing is deleted here.
