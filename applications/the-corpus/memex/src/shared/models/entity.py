...
class ExtractedEntity(BaseModel):
    ...
    entity_type: str = Field(description="Type of entity (e.g., 'Bill', 'Member')")
    ...
    # Domain
    domain: str = Field(default="congressional", description="Domain this entity belongs to")
    ...
    def id(self) -> str | None:
        ...
        for key in ["id", "number", "bioguide_id", "system_code"]:
